...
const DanhMucModel_1 = require("../models/DanhMucModel");
const SanPhamModel_1 = require("../models/SanPhamModel");
const HinhAnhSPModel_1 = require("../models/HinhAnhSPModel");
class DanhMucService {
    static getAll() {
        return __awaiter(this, void 0, void 0, function* () {
            const danhMucResult = yield db_1.default.query(`SELECT * FROM danh_muc ORDER BY ten_danh_muc`);
            const danhMucList = [];
            ...
            `, [dm.id]);
                ...
                danhMucList.push(new DanhMucModel_1.DanhMucModel(dm.id, dm.ten_danh_muc, dm.icon, san_phams));
            }
            return danhMucList;
        });
    }
